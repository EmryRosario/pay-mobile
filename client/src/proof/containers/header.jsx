  ...
  render () {
    ...
    return (<div id={`proof-header-${this.props.proof['REC_NUMERO']}`} className={'col-xs-12  no-padding-right no-padding-left'}>
      <div id={'address-info'} className={'col-xs-12 text-center no-padding-left '}>
        <div className={'col-xs-12 text-center'}><span className={'proof-title'}>{this.props.company['PAR_NOMEMP']} </span></div>
        ...
        <div className={'col-xs-6 text-right'}><span>{`No. DE CUOTAS: `} {this.props.proof['REC_CUOTAS']}</span></div>
